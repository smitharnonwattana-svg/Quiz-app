...
- Line ~30: `<!-- APP_VERSION: v47.52 -->`
- Line ~853: `>v47.52</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.52';`  (version check script)

### Current version: v47.52
When making the next change, bump to v47.53.
