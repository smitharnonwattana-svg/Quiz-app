...
- Line ~30: `<!-- APP_VERSION: v47.65 -->`
- Line ~853: `>v47.65</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.65';`  (version check script)

### Current version: v47.65
When making the next change, bump to v47.66.
