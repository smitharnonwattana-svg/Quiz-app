...
- Line ~30: `<!-- APP_VERSION: v48.12 -->`
- Line ~1083: `>v48.12</div>`  (login page display)
- Line ~13826: `const CURRENT_VERSION = 'v48.12';`  (version check script)

### Current version: v48.12
When making the next change, bump to v48.13.
