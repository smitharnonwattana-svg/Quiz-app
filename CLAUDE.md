...
- Line ~30: `<!-- APP_VERSION: v47.66 -->`
- Line ~853: `>v47.66</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.66';`  (version check script)

### Current version: v47.66
When making the next change, bump to v47.67.
