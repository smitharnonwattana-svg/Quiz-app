...
- Line ~30: `<!-- APP_VERSION: v47.50 -->`
- Line ~853: `>v47.50</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.50';`  (version check script)

### Current version: v47.50
When making the next change, bump to v47.51.
