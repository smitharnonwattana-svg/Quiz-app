...
- Line ~30: `<!-- APP_VERSION: v47.61 -->`
- Line ~853: `>v47.61</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.61';`  (version check script)

### Current version: v47.61
When making the next change, bump to v47.62.
