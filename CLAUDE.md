...
- Line ~30: `<!-- APP_VERSION: v47.56 -->`
- Line ~853: `>v47.56</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.56';`  (version check script)

### Current version: v47.56
When making the next change, bump to v47.57.
