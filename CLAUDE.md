...
- Line ~30: `<!-- APP_VERSION: v47.39 -->`
- Line ~853: `>v47.39</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.39';`  (version check script)

### Current version: v47.39
When making the next change, bump to v47.40.
