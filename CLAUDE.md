...
- Line ~30: `<!-- APP_VERSION: v47.97 -->`
- Line ~1072: `>v47.97</div>`  (login page display)
- Line ~13253: `const CURRENT_VERSION = 'v47.97';`  (version check script)

### Current version: v47.97
When making the next change, bump to v47.98.
