...
- Line ~30: `<!-- APP_VERSION: v47.62 -->`
- Line ~853: `>v47.62</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.62';`  (version check script)

### Current version: v47.62
When making the next change, bump to v47.63.
