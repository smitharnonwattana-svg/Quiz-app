...
- Line ~30: `<!-- APP_VERSION: v47.44 -->`
- Line ~853: `>v47.44</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.44';`  (version check script)

### Current version: v47.44
When making the next change, bump to v47.45.
