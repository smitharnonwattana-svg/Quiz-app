...
- Line ~30: `<!-- APP_VERSION: v47.68 -->`
- Line ~853: `>v47.68</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.68';`  (version check script)

### Current version: v47.68
When making the next change, bump to v47.69.
