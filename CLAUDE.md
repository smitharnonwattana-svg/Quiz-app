...
- Line ~30: `<!-- APP_VERSION: v47.48 -->`
- Line ~853: `>v47.48</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.48';`  (version check script)

### Current version: v47.48
When making the next change, bump to v47.49.
