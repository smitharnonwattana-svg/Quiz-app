...
- Line ~30: `<!-- APP_VERSION: v47.53 -->`
- Line ~853: `>v47.53</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.53';`  (version check script)

### Current version: v47.53
When making the next change, bump to v47.54.
