...
- Line ~30: `<!-- APP_VERSION: v47.99 -->`
- Line ~1072: `>v47.99</div>`  (login page display)
- Line ~13299: `const CURRENT_VERSION = 'v47.99';`  (version check script)

### Current version: v47.99
When making the next change, bump to v48.0.
