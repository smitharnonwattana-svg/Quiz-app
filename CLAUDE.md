...
- Line ~30: `<!-- APP_VERSION: v47.60 -->`
- Line ~853: `>v47.60</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.60';`  (version check script)

### Current version: v47.60
When making the next change, bump to v47.61.
