...
- Line ~30: `<!-- APP_VERSION: v48.4 -->`
- Line ~1079: `>v48.4</div>`  (login page display)
- Line ~13404: `const CURRENT_VERSION = 'v48.4';`  (version check script)

### Current version: v48.4
When making the next change, bump to v48.5.
