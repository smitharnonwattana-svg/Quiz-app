...
- Line ~30: `<!-- APP_VERSION: v47.95 -->`
- Line ~1072: `>v47.95</div>`  (login page display)
- Line ~12979: `const CURRENT_VERSION = 'v47.95';`  (version check script)

### Current version: v47.95
When making the next change, bump to v47.96.
