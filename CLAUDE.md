...
- Line ~30: `<!-- APP_VERSION: v47.73 -->`
- Line ~936: `>v47.73</div>`  (login page display)
- Line ~12838: `const CURRENT_VERSION = 'v47.73';`  (version check script)

### Current version: v47.73
When making the next change, bump to v47.74.
