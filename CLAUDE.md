...
- Line ~7: `<!-- APP_VERSION: v45.54 -->`
- Line ~352: `<div style="text-align:right;margin-top:10px;font-size:11px;color:#9ca3af;opacity:0.6;">v45.54</div>`

### Current version: v45.54
When making the next change, bump to v45.55.
