...
- Line ~30: `<!-- APP_VERSION: v47.49 -->`
- Line ~853: `>v47.49</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.49';`  (version check script)

### Current version: v47.49
When making the next change, bump to v47.50.
