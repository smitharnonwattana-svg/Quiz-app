...
- Line ~30: `<!-- APP_VERSION: v47.41 -->`
- Line ~853: `>v47.41</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.41';`  (version check script)

### Current version: v47.41
When making the next change, bump to v47.42.
