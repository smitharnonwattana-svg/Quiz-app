...
- Line ~30: `<!-- APP_VERSION: v47.70 -->`
- Line ~853: `>v47.70</div>`  (login page display)
- Line ~11763: `const CURRENT_VERSION = 'v47.70';`  (version check script)

### Current version: v47.70
When making the next change, bump to v47.71.
