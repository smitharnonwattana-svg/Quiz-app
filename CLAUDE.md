...
- Line ~30: `<!-- APP_VERSION: v47.42 -->`
- Line ~853: `>v47.42</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.42';`  (version check script)

### Current version: v47.42
When making the next change, bump to v47.43.
