...
- Line ~30: `<!-- APP_VERSION: v47.40 -->`
- Line ~853: `>v47.40</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.40';`  (version check script)

### Current version: v47.40
When making the next change, bump to v47.41.
