...
- Line ~7: `<!-- APP_VERSION: v47.24 -->`
- Line ~852: `>v47.24</div>`  (login page display)
- Line ~11325: `const CURRENT_VERSION = 'v47.24';`  (version check script)

### Current version: v47.24
When making the next change, bump to v47.25.
