...
- Line ~30: `<!-- APP_VERSION: v48.5 -->`
- Line ~1079: `>v48.5</div>`  (login page display)
- Line ~13404: `const CURRENT_VERSION = 'v48.5';`  (version check script)

### Current version: v48.5
When making the next change, bump to v48.6.
