...
- Line ~30: `<!-- APP_VERSION: v48.0 -->`
- Line ~1072: `>v48.0</div>`  (login page display)
- Line ~13315: `const CURRENT_VERSION = 'v48.0';`  (version check script)

### Current version: v48.0
When making the next change, bump to v48.1.
