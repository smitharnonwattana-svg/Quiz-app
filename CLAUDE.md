...
- Line ~30: `<!-- APP_VERSION: v47.96 -->`
- Line ~1072: `>v47.96</div>`  (login page display)
- Line ~13262: `const CURRENT_VERSION = 'v47.96';`  (version check script)

### Current version: v47.96
When making the next change, bump to v47.97.
