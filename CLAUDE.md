...
- Line ~30: `<!-- APP_VERSION: v47.54 -->`
- Line ~853: `>v47.54</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.54';`  (version check script)

### Current version: v47.54
When making the next change, bump to v47.55.
