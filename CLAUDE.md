...
- Line ~30: `<!-- APP_VERSION: v47.98 -->`
- Line ~1072: `>v47.98</div>`  (login page display)
- Line ~13263: `const CURRENT_VERSION = 'v47.98';`  (version check script)

### Current version: v47.98
When making the next change, bump to v47.99.
