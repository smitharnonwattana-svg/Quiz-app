...
- Line ~30: `<!-- APP_VERSION: v47.69 -->`
- Line ~853: `>v47.69</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.69';`  (version check script)

### Current version: v47.69
When making the next change, bump to v47.70.
