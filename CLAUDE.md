...
- Line ~30: `<!-- APP_VERSION: v47.71 -->`
- Line ~936: `>v47.71</div>`  (login page display)
- Line ~12838: `const CURRENT_VERSION = 'v47.71';`  (version check script)

### Current version: v47.71
When making the next change, bump to v47.72.
