...
- Line ~30: `<!-- APP_VERSION: v47.46 -->`
- Line ~853: `>v47.46</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.46';`  (version check script)

### Current version: v47.46
When making the next change, bump to v47.47.
