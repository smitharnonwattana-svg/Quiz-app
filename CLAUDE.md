...
- Line ~30: `<!-- APP_VERSION: v48.3 -->`
- Line ~1079: `>v48.3</div>`  (login page display)
- Line ~13362: `const CURRENT_VERSION = 'v48.3';`  (version check script)

### Current version: v48.3
When making the next change, bump to v48.4.
