...
- Line ~7: `<!-- APP_VERSION: v47.26 -->`
- Line ~852: `>v47.26</div>`  (login page display)
- Line ~11333: `const CURRENT_VERSION = 'v47.27';`  (version check script)

### Current version: v47.27
When making the next change, bump to v47.28.
