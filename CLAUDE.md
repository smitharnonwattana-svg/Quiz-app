...
- Line ~30: `<!-- APP_VERSION: v47.59 -->`
- Line ~853: `>v47.59</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.59';`  (version check script)

### Current version: v47.59
When making the next change, bump to v47.60.
