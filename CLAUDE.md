...
- Line ~30: `<!-- APP_VERSION: v47.55 -->`
- Line ~853: `>v47.55</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.55';`  (version check script)

### Current version: v47.55
When making the next change, bump to v47.56.
