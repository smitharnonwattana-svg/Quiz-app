...
- Line ~30: `<!-- APP_VERSION: v47.57 -->`
- Line ~853: `>v47.57</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.57';`  (version check script)

### Current version: v47.57
When making the next change, bump to v47.58.
