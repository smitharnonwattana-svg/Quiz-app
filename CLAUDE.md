...
- Line ~30: `<!-- APP_VERSION: v48.9 -->`
- Line ~1079: `>v48.9</div>`  (login page display)
- Line ~13726: `const CURRENT_VERSION = 'v48.9';`  (version check script)

### Current version: v48.9
When making the next change, bump to v48.10.
