...
- Line ~30: `<!-- APP_VERSION: v47.58 -->`
- Line ~853: `>v47.58</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.58';`  (version check script)

### Current version: v47.58
When making the next change, bump to v47.59.
