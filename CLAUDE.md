...
- Line ~30: `<!-- APP_VERSION: v47.43 -->`
- Line ~853: `>v47.43</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.43';`  (version check script)

### Current version: v47.43
When making the next change, bump to v47.44.
