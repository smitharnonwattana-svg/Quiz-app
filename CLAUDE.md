...
- Line ~30: `<!-- APP_VERSION: v47.45 -->`
- Line ~853: `>v47.45</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.45';`  (version check script)

### Current version: v47.45
When making the next change, bump to v47.46.
