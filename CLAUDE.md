...
- Line ~30: `<!-- APP_VERSION: v48.1 -->`
- Line ~1072: `>v48.1</div>`  (login page display)
- Line ~13320: `const CURRENT_VERSION = 'v48.1';`  (version check script)

### Current version: v48.1
When making the next change, bump to v48.2.
