...
- Line ~30: `<!-- APP_VERSION: v47.64 -->`
- Line ~853: `>v47.64</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.64';`  (version check script)

### Current version: v47.64
When making the next change, bump to v47.65.
