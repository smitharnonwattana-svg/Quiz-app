...
- Line ~30: `<!-- APP_VERSION: v47.47 -->`
- Line ~853: `>v47.47</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.47';`  (version check script)

### Current version: v47.47
When making the next change, bump to v47.48.
