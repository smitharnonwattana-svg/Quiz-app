...
- Line ~30: `<!-- APP_VERSION: v47.72 -->`
- Line ~936: `>v47.72</div>`  (login page display)
- Line ~12838: `const CURRENT_VERSION = 'v47.72';`  (version check script)

### Current version: v47.72
When making the next change, bump to v47.73.
