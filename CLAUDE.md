...
- Line ~30: `<!-- APP_VERSION: v47.74 -->`
- Line ~983: `>v47.74</div>`  (login page display)
- Line ~12889: `const CURRENT_VERSION = 'v47.74';`  (version check script)

### Current version: v47.74
When making the next change, bump to v47.75.
