...
- Line ~7: `<!-- APP_VERSION: v45.63 -->`
- Line ~352: `<div style="text-align:right;margin-top:10px;font-size:11px;color:#9ca3af;opacity:0.6;">v45.63</div>`

### Current version: v45.63
When making the next change, bump to v45.64.
