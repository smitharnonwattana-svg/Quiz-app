...
- Line ~30: `<!-- APP_VERSION: v47.67 -->`
- Line ~853: `>v47.67</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.67';`  (version check script)

### Current version: v47.67
When making the next change, bump to v47.68.
