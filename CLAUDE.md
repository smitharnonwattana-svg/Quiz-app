...
- Line ~30: `<!-- APP_VERSION: v48.6 -->`
- Line ~1079: `>v48.6</div>`  (login page display)
- Line ~13604: `const CURRENT_VERSION = 'v48.6';`  (version check script)

### Current version: v48.6
When making the next change, bump to v48.7.
