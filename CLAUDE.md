...
- Line ~30: `<!-- APP_VERSION: v47.63 -->`
- Line ~853: `>v47.63</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.63';`  (version check script)

### Current version: v47.63
When making the next change, bump to v47.64.
