...
- Line ~30: `<!-- APP_VERSION: v47.51 -->`
- Line ~853: `>v47.51</div>`  (login page display)
- Line ~11631: `const CURRENT_VERSION = 'v47.51';`  (version check script)

### Current version: v47.51
When making the next change, bump to v47.52.
